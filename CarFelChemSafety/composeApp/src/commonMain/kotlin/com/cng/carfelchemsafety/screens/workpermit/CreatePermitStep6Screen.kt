...
fun CreatePermitStep6Screen(
    ...
    Column(
        ...
        StepProgressIndicator(
            ...
            stepLabel = strings.stepOf.format(6, totalSteps)
        )
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(strings.responsibleName) },
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.updateResponsibleRole(it) },
                label = { Text(strings.responsibleRole) },
                modifier = Modifier.fillMaxWidth()
            )
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.updateHealthInfo(it) },
                label = { Text(strings.healthInfo) },
                modifier = Modifier.fillMaxWidth(),
                minLines = 3
            )
        }
